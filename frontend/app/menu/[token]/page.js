...
export default function MenuPublico() {
  ...
  const styles = {
    ...
    tab: (active) => ({
      ...
      color: active ? '#1a3c8f' : '#64748b',
      borderBottom: active ? '2px solid #1a3c8f' : '2px solid transparent',
      cursor: 'pointer',
      whiteSpace: 'nowrap',
      background: 'none',
      border: 'none',
    ...
    counterBtn: (variant) => ({
      ...
      height: '30px',
      borderRadius: '50%',
      border: variant === 'minus' ? '1.5px solid #cbd5e1' : '1.5px solid #1a3c8f',
      background: variant === 'minus' ? 'white' : '#1a3c8f',
    ...
    submitBtn: (disabled) => ({
      padding: '12px 28px',
      background: disabled ? '#94a3b8' : '#1a3c8f',
      color: 'white',
      border: 'none',
      borderRadius: '10px',
      fontSize: '15px',
        ...
        <div style={styles.thankYouCard}>
          ...
          <div style={styles.thankYouDivider}>
            ...
            <div style={styles.contactInfo}>
              <a href="tel:+17876278585" style={styles.contactLink}>+1 (787) 627-8585</a><br />
              <a href="mailto:info@energydepotpr.com" style={styles.contactLink}>info@energydepotpr.com</a><br />
              <a href="https://energydepotpr.com" target="_blank" rel="noreferrer" style={styles.contactLink}>energydepotpr.com</a>
            </div>
          </div>
        </div>
      </div>
      ...
      <div style={styles.centerScreen}>
        <div style={styles.errorCard}>
          ...
          <div style={{ marginTop: '24px', fontSize: '13px', color: '#94a3b8' }}>
            Contacta a Energy Depot PR para obtener un nuevo enlace.
          </div>
        </div>
      </div>
    );
