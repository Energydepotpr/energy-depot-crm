...
const NAV_MOBILE = [
  ...
  { href: '/citas',     label: 'Calendario', tKey: 'nav.citas', icon: 'M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z' },
...
const NAV_SIDEBAR_EXTRA = [
  ...
  { href: '/contabilidad', label: 'Contabilidad', tKey: 'nav.accounting', icon: 'M9 7h6m-6 4h6m-6 4h4M5 3h14a2 2 0 012 2v14a2 2 0 01-2 2H5a2 2 0 01-2-2V5a2 2 0 012-2z', section: 'Finanzas', sKey: 'sec.finance' },
  ...
  */
  // Marketing
  { href: '/marketing',    label: 'Marketing ROI', tKey: 'nav.marketing',   icon: 'M3 3v18h18M7 14l3-3 4 4 5-7', section: 'Marketing', sKey: 'sec.marketing' },
  // Comunicación
