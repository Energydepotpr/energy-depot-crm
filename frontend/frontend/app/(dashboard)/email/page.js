        ...
        <div style={{ padding: '14px 18px', display: 'flex', flexDirection: 'column', gap: 10, flex: 1, overflowY: 'auto' }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 4 }}>
            ...
            <select value={form.account} onChange={e => set('account', e.target.value)}
              ...
              <option value="operations">operations@fixatrippr.com</option>
              <option value="bookings">bookings@fixatrippr.com</option>
            </select>
          </div>
            ...
            <div>
              ...
              {selected.account && (
                <div style={{ fontSize: 11, color: C.muted, marginTop: 2 }}>
                  {t('email.account_label', lang)} {selected.account}@fixatrippr.com
                </div>
              )}
            </div>
          </div>
