...
const NAV_SIDEBAR_EXTRA = [
  ...
  */
  ...
  // Reportes
  { href: '/metricas',     label: 'Métricas',     tKey: 'nav.metrics',       icon: 'M16 8v8m-4-5v5m-4-2v2M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z', section: 'Reportes', sKey: 'sec.reports' },
  { href: '/reportes',     label: 'Financiero',   tKey: 'nav.financial',     icon: 'M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z', section: 'Reportes', sKey: 'sec.reports' },
  { href: '/metas',        label: 'Metas',        tKey: 'nav.goals',         icon: 'M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z', section: 'Reportes', sKey: 'sec.reports' },
  { href: '/api-docs',     label: 'API Docs',     tKey: 'nav.apidocs',       icon: 'M10 20l4-16m4 4l4 4-4 4M6 16l-4-4 4-4', section: 'Reportes', sKey: 'sec.reports' },
  // Config
...
export default function DashboardLayout({ children }) {
  ...
  if (loading || !user) return (
    <div style={{ minHeight: '100vh', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', gap: 20, background: 'var(--bg)' }}>
      <Image src="/logo.webp" alt="Fix A Trip PR" width={80} height={80} style={{ borderRadius: 16, objectFit: 'contain' }} priority />
    ...
    <div style={{ display: 'flex', minHeight: '100vh', maxWidth: '100vw', overflowX: 'hidden' }}>
      ...
      <aside className="desktop-sidebar" style={{
        ...
        <div style={{ width: 68, height: 58, display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0 }}>
          <div style={{ width: 38, height: 38, borderRadius: '50%', overflow: 'hidden', background: 'var(--sidebar-border)', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
            <Image src="/logo.webp" alt="FAT" width={38} height={38} className="object-cover" style={{ width: 38, height: 38 }} priority />
          </div>
        </div>
      ...
      <div style={{ flex: 1, display: 'flex', flexDirection: 'column', minHeight: '100vh', minWidth: 0 }}>
        ...
        <header className="mobile-header" style={{
          ...
          <Image src="/logo.webp" alt="Fix A Trip PR" width={90} height={30} className="object-contain" style={{ maxHeight: 26 }} priority />
