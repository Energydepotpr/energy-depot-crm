              ...
              <div style={{ background: 'rgba(99,102,241,0.08)', border: `1px solid ${T.border}`, borderRadius: 12, padding: '14px 16px' }}>
                <label style={{ display: 'flex', gap: 12, cursor: 'pointer', alignItems: 'flex-start' }}>
                  ...
                  <span style={{ fontSize: 12, color: T.muted, lineHeight: 1.6 }}>
                    I agree to receive SMS text messages from <strong style={{ color: T.text }}>Fix A Trip Puerto Rico</strong> regarding my booking confirmation, day-before activity reminders, real-time trip updates, and post-experience feedback requests. Message frequency varies. Message &amp; data rates may apply. Reply <strong style={{ color: T.text }}>STOP</strong> to opt out at any time. Reply <strong style={{ color: T.text }}>HELP</strong> for help.
                  </span>
                </label>
